    ...
    <article className="flex w-[368px] h-[500px] shrink-0 flex-col overflow-hidden rounded-2xl bg-primary-white shadow-[0px_4px_6px_-4px_rgba(0,0,0,0.1),0px_10px_15px_-3px_rgba(0,0,0,0.1)]">
      <div className="relative">
        ...
        <div className="absolute left-3 top-[163px]">
          <span className="inline-flex rounded-[20px] bg-primary-blue px-2.5 py-1 font-dm-sans text-[14px] font-bold leading-6 tracking-[0.04em] text-primary-white">
            {type}
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 p-4  min-h-0">
        ...
        <span className="font-symbol text-[16px] leading-6 text-secondary-black/50">
          {date}
        </span>
      </div>
    </article>
