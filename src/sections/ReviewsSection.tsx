...
export default function ReviewsSection() {
  ...
  return (
    <section className="max-h-[595px] bg-gradient-to-b from-eggshell-bgr to-primary-white py-25">
      <div className="flex flex-col items-center gap-15">
        <h2 className="text-center font-marcellus text-[40px] leading-[120%] tracking-[0.01em] text-primary-black">
          Mnenja naših strank
        </h2>

        <div className="flex justify-center w-full pb-[30px] overflow-hidden gap-5">
