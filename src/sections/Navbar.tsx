...
export default function Navbar() {
  return (
    <header className="flex items-center justify-between px-10 py-2 bg-gradient-to-b from-black/30 to-transparent">

      <div className="flex items-center gap-10">
        <img src={Logo} alt="Logo" className="h-[56px] w-auto" />

        <nav className="hidden md:flex items-center gap-6 font-dm-sans text-[15px] font-medium leading-[150%] text-white">
      ...
      <div className="flex items-center gap-6 text-sm">
        <div className="hidden md:flex items-center gap-1.5 font-dm-sans text-[15px] font-medium leading-[150%] text-white">
